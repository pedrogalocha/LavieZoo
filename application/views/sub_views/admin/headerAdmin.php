...
<head>
  ...
  <title>LavieZoo - Dashboard</title>

  <!-- Custom fonts for this template-->
  <link href="<?php echo base_url('/includes/css/sb-admin-2.min.css') ?>" rel="stylesheet">
  <link href="<?php echo base_url('/includes/vendor/fontawesome-free/css/all.min.css') ?>" rel="stylesheet"
    type="text/css">
  <link
    href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
    rel="stylesheet">
  <link href="<?php echo base_url('/includes/css/datatables.min.css') ?>" rel="stylesheet">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3">LavieZoo <sup>ADMIN</sup></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true"
          ...
          <span>Gerenciamento Usuários</span>
        </a>
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Áreas:</h6>
            <a class="collapse-item" href="<?php echo base_url('exibeVets') ?>">Veterinarios</a>
            <a class="collapse-item" href="<?php echo base_url('exibeCli') ?>">Clinicas</a>
          </div>
        </div>
      </li>
