      ...
      <form class="text-dark text-uppercase needs-validation" method="POST" id="form_cad" action='<?php echo base_url('cadastrarAgendamento') ?>' novalidate autocomplete="off">
        ...
        <div class="pt-5 container col-sm-8 mx-auto align-self-center align-items-center justify-content-center">
          ...
          <div class="px-2 form-group row">
            ...
            <div class="px-2 form-group row">
              <div class="col-md-12 mx-auto ">
                <label class="align-self-center font-weight-bold" required for="inputOutros">Outros Exames: </label>
          ...
          <div class="pt-2 container col-sm-12 mx-auto align-self-center align-items-center justify-content-center" style="margin-top:30px; margin-bottom:30px; background-color: #F9F2C7">
            ...
            <div class="col-md-8 mx-auto mb-2 ">
                <div class="pt-2 form-check form-check">
                  <input onchange="ocultaData();ocultaAgend()" class="form-check-input" type="radio" name="inlineRadioOptions3" id="inlineRadioOptions2"
                ...
                <div class="pt-2 form-check form-check" tyle="
                  ...
                  <input onchange="ocultaData();exibeAgend()" class="form-check-input" type="radio" name="inlineRadioOptions3" id="inlineRadioOptions3"
                    value="buscaDomiciliar" >
          ...
          <div class="px-2 pt-4 form-group row " style="
            ...
            <div class="col-md-12 mx-auto ">
              ...
              <input type="text" class="coleta-clinica form-control text-uppercase text-left" name="inputEndereco" id="inputEndereco"
      ...
      <script>   
        ...
        function validaData(){
          ...
          if(data == '' || data < date2){
            ...
            dataType : "html",
            type: 'POST', 
            data: {data_selecionada: data_to_be_sent}, 
            ...
            success: function(results){
              ...
              $.each(faixaHorarios2, function(index) {
                  $("#faixaHorario").append("<option id='faix' value ='" + faixaHorarios2[index].FAIXA_HORARIO_ID +"'>" + faixaHorarios2[index].DS_FAIXA_HORARIO+ "</option>");
              });
            }
            }); 
            return false;
