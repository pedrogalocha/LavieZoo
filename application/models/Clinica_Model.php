...
class Clinica_Model extends CI_Model
{
    ...
    {
        $qCli = "SELECT c.CLINICA_NOME_FANTASIA, c.CLINICA_CNPJ,c.CLINICA_RESPONSAVEL_NOME,u.USUARIO_NIVEL_ACESSO, u.ID_USUARIO, u.USUARIO_EMAIL ,u.USUARIO_SENHA FROM tb_clinica c
