...
CREATE TABLE `tb_clinica` (
  ...
  `CLINICA_CNPJ` varchar(15) NOT NULL,
...
INSERT INTO `tb_clinica` VALUES (1,'Clinica SÃO BENTO','72367171000164','Pedro Galocha','1993-06-14','41803259850','Masculino','SIM','Rua Embirucu, 123','cASA','JARDIM PLANALTO','SP','Mogi das Cruzes','08760-040','11994179336'),(17,'CLINICA SALIM','123125412312321','Pedro Galocha','1963-06-15','51618971981','Masculino','NAO','Rua Embirucu','Jardim Planalto','Jardim Planalto','SP','Mogi das Cruzes','08760040','(11) 99417-9336');
...
-- Dump completed on 2019-10-18 21:45:37
