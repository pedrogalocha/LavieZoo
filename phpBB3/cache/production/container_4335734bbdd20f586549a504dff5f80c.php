...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000478adb550000000045e449b2(
...
class phpbbtemplatetwiglexer_00000000478adb550000000045e449b2 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d4c00370add6291396176 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d4c00370addf129356827 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d4c00370adb4653801738 = array(
    ...
    {
        $this->initializer5d4c00370addf129356827 && ($this->initializer5d4c00370addf129356827->__invoke($valueHolder5d4c00370add6291396176, $this, 'set_environment', array('env' => $env), $this->initializer5d4c00370addf129356827) || 1) && $this->valueHolder5d4c00370add6291396176 = $valueHolder5d4c00370add6291396176;

        return $this->valueHolder5d4c00370add6291396176->set_environment($env);
    }
    ...
    {
        $this->initializer5d4c00370addf129356827 && ($this->initializer5d4c00370addf129356827->__invoke($valueHolder5d4c00370add6291396176, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d4c00370addf129356827) || 1) && $this->valueHolder5d4c00370add6291396176 = $valueHolder5d4c00370add6291396176;

        return $this->valueHolder5d4c00370add6291396176->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d4c00370addf129356827 && ($this->initializer5d4c00370addf129356827->__invoke($valueHolder5d4c00370add6291396176, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d4c00370addf129356827) || 1) && $this->valueHolder5d4c00370add6291396176 = $valueHolder5d4c00370add6291396176;

        return $this->valueHolder5d4c00370add6291396176->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d4c00370addf129356827 = $initializer;
    }
    ...
    {
        $this->initializer5d4c00370addf129356827 && ($this->initializer5d4c00370addf129356827->__invoke($valueHolder5d4c00370add6291396176, $this, '__get', array('name' => $name), $this->initializer5d4c00370addf129356827) || 1) && $this->valueHolder5d4c00370add6291396176 = $valueHolder5d4c00370add6291396176;

        if (isset(self::$publicProperties5d4c00370adb4653801738[$name])) {
            return $this->valueHolder5d4c00370add6291396176->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d4c00370add6291396176;
    ...
    {
        $this->initializer5d4c00370addf129356827 && ($this->initializer5d4c00370addf129356827->__invoke($valueHolder5d4c00370add6291396176, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d4c00370addf129356827) || 1) && $this->valueHolder5d4c00370add6291396176 = $valueHolder5d4c00370add6291396176;
    ...
    {
        $this->initializer5d4c00370addf129356827 && ($this->initializer5d4c00370addf129356827->__invoke($valueHolder5d4c00370add6291396176, $this, '__isset', array('name' => $name), $this->initializer5d4c00370addf129356827) || 1) && $this->valueHolder5d4c00370add6291396176 = $valueHolder5d4c00370add6291396176;
    ...
    {
        $this->initializer5d4c00370addf129356827 && ($this->initializer5d4c00370addf129356827->__invoke($valueHolder5d4c00370add6291396176, $this, '__unset', array('name' => $name), $this->initializer5d4c00370addf129356827) || 1) && $this->valueHolder5d4c00370add6291396176 = $valueHolder5d4c00370add6291396176;
    ...
    {
        $this->initializer5d4c00370addf129356827 && ($this->initializer5d4c00370addf129356827->__invoke($valueHolder5d4c00370add6291396176, $this, '__clone', array(), $this->initializer5d4c00370addf129356827) || 1) && $this->valueHolder5d4c00370add6291396176 = $valueHolder5d4c00370add6291396176;

        $this->valueHolder5d4c00370add6291396176 = clone $this->valueHolder5d4c00370add6291396176;
    }

    public function __sleep()
    {
        $this->initializer5d4c00370addf129356827 && ($this->initializer5d4c00370addf129356827->__invoke($valueHolder5d4c00370add6291396176, $this, '__sleep', array(), $this->initializer5d4c00370addf129356827) || 1) && $this->valueHolder5d4c00370add6291396176 = $valueHolder5d4c00370add6291396176;

        return array('valueHolder5d4c00370add6291396176');
    }
    ...
    {
        return $this->initializer5d4c00370addf129356827;
    }
    ...
    {
        return $this->initializer5d4c00370addf129356827 && ($this->initializer5d4c00370addf129356827->__invoke($valueHolder5d4c00370add6291396176, $this, 'initializeProxy', array(), $this->initializer5d4c00370addf129356827) || 1) && $this->valueHolder5d4c00370add6291396176 = $valueHolder5d4c00370add6291396176;
    }
    ...
    {
        return null !== $this->valueHolder5d4c00370add6291396176;
    }
    ...
    {
        return $this->valueHolder5d4c00370add6291396176;
    }
