...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000c4529cd000000005730e9a3(
...
class phpbbtemplatetwiglexer_000000000c4529cd000000005730e9a3 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d4c001354ba1811295388 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d4c001354bab751560709 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d4c001354b7f008628826 = array(
    ...
    {
        $this->initializer5d4c001354bab751560709 && ($this->initializer5d4c001354bab751560709->__invoke($valueHolder5d4c001354ba1811295388, $this, 'set_environment', array('env' => $env), $this->initializer5d4c001354bab751560709) || 1) && $this->valueHolder5d4c001354ba1811295388 = $valueHolder5d4c001354ba1811295388;

        return $this->valueHolder5d4c001354ba1811295388->set_environment($env);
    }
    ...
    {
        $this->initializer5d4c001354bab751560709 && ($this->initializer5d4c001354bab751560709->__invoke($valueHolder5d4c001354ba1811295388, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d4c001354bab751560709) || 1) && $this->valueHolder5d4c001354ba1811295388 = $valueHolder5d4c001354ba1811295388;

        return $this->valueHolder5d4c001354ba1811295388->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d4c001354bab751560709 && ($this->initializer5d4c001354bab751560709->__invoke($valueHolder5d4c001354ba1811295388, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d4c001354bab751560709) || 1) && $this->valueHolder5d4c001354ba1811295388 = $valueHolder5d4c001354ba1811295388;

        return $this->valueHolder5d4c001354ba1811295388->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d4c001354bab751560709 = $initializer;
    }
    ...
    {
        $this->initializer5d4c001354bab751560709 && ($this->initializer5d4c001354bab751560709->__invoke($valueHolder5d4c001354ba1811295388, $this, '__get', array('name' => $name), $this->initializer5d4c001354bab751560709) || 1) && $this->valueHolder5d4c001354ba1811295388 = $valueHolder5d4c001354ba1811295388;

        if (isset(self::$publicProperties5d4c001354b7f008628826[$name])) {
            return $this->valueHolder5d4c001354ba1811295388->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d4c001354ba1811295388;
    ...
    {
        $this->initializer5d4c001354bab751560709 && ($this->initializer5d4c001354bab751560709->__invoke($valueHolder5d4c001354ba1811295388, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d4c001354bab751560709) || 1) && $this->valueHolder5d4c001354ba1811295388 = $valueHolder5d4c001354ba1811295388;
    ...
    {
        $this->initializer5d4c001354bab751560709 && ($this->initializer5d4c001354bab751560709->__invoke($valueHolder5d4c001354ba1811295388, $this, '__isset', array('name' => $name), $this->initializer5d4c001354bab751560709) || 1) && $this->valueHolder5d4c001354ba1811295388 = $valueHolder5d4c001354ba1811295388;
    ...
    {
        $this->initializer5d4c001354bab751560709 && ($this->initializer5d4c001354bab751560709->__invoke($valueHolder5d4c001354ba1811295388, $this, '__unset', array('name' => $name), $this->initializer5d4c001354bab751560709) || 1) && $this->valueHolder5d4c001354ba1811295388 = $valueHolder5d4c001354ba1811295388;
    ...
    {
        $this->initializer5d4c001354bab751560709 && ($this->initializer5d4c001354bab751560709->__invoke($valueHolder5d4c001354ba1811295388, $this, '__clone', array(), $this->initializer5d4c001354bab751560709) || 1) && $this->valueHolder5d4c001354ba1811295388 = $valueHolder5d4c001354ba1811295388;

        $this->valueHolder5d4c001354ba1811295388 = clone $this->valueHolder5d4c001354ba1811295388;
    }

    public function __sleep()
    {
        $this->initializer5d4c001354bab751560709 && ($this->initializer5d4c001354bab751560709->__invoke($valueHolder5d4c001354ba1811295388, $this, '__sleep', array(), $this->initializer5d4c001354bab751560709) || 1) && $this->valueHolder5d4c001354ba1811295388 = $valueHolder5d4c001354ba1811295388;

        return array('valueHolder5d4c001354ba1811295388');
    }
    ...
    {
        return $this->initializer5d4c001354bab751560709;
    }
    ...
    {
        return $this->initializer5d4c001354bab751560709 && ($this->initializer5d4c001354bab751560709->__invoke($valueHolder5d4c001354ba1811295388, $this, 'initializeProxy', array(), $this->initializer5d4c001354bab751560709) || 1) && $this->valueHolder5d4c001354ba1811295388 = $valueHolder5d4c001354ba1811295388;
    }
    ...
    {
        return null !== $this->valueHolder5d4c001354ba1811295388;
    }
    ...
    {
        return $this->valueHolder5d4c001354ba1811295388;
    }
